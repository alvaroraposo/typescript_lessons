...
/**
 * If you expose your functions as an API to the outside world, it’s
always a good idea to do extra typeof checks and proper error handling.
 */

/**
 * If we want to make sure we don’t get any emitted JavaScript
 * output, set noEmitOnError to true in tsconfig.json.
 */
